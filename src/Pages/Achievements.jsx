...
const munImages = [mun1, mun2, mun3, mun4, mun5, mun6, mun7, mun8, mun9, mun10, mun11];
...
/* ---------- Category Section ---------- */
function CategorySection({ title, subtitle, icon, achievements, images, video, galleryFirst = false }) {
  return (
    <Box sx={{ mb: 8 }}>
      <SectionHeader title={title} subtitle={subtitle} icon={icon} />
      
      {/* Image Gallery with Optional Video - Show first if galleryFirst is true */}
      {galleryFirst && (images && images.length > 0 || video) && (
        <Box sx={{ mb: 6 }}>
          <ImageGallery images={images} video={video} title={`${title} Gallery`} />
        </Box>
      )}
      ...
      {/* Image Gallery with Optional Video - Show after cards if galleryFirst is false */}
      {!galleryFirst && (images && images.length > 0 || video) && (
        <Box sx={{ mt: 4 }}>
          <ImageGallery images={images} video={video} title={`${title} Gallery`} />
        </Box>
    ...
    >
      <Container maxWidth="lg">
        ...
        <Stack alignItems="center" spacing={2} sx={{ mb: 8, textAlign: "center" }}>
          ...
          >
            A collection of accomplishments spanning academics, technology, athletics, and international experiences
          </Typography>
    ...
    >
      <Container maxWidth="md">
        ...
        <Stack alignItems="center" spacing={1.5} sx={{ mb: 6, textAlign: "center", px: 2 }}>
          ...
          >
            Accomplishments across academics, technology, and athletics
          </Typography>
          <Divider sx={{ width: 80, height: 3, bgcolor: "#22d3ee", borderRadius: 2, mt: 1 }} />
        </Stack>
