...
const leadershipExperience = [
  {
    image: "https://gateway.lk/wp-content/uploads/2019/08/gateway-logo.png",
    title: "Secretary General - Model UN",
    company: "Gateway College Colombo",
    ...
    responsibilities: [
      "Led organization of Gateway College's annual MUN conference",
      "Oversaw committee operations and delegate coordination",
      "Ensured adherence to UN parliamentary procedures",
      "Managed conference logistics and event planning",
      "Trained committee chairs and delegates",
      "Facilitated international diplomacy education",
    ],
    skills: ["Leadership", "Event Management", "Public Speaking", "Diplomacy", "Team Coordination"],
  },
  {
    image: "https://gateway.lk/wp-content/uploads/2019/08/gateway-logo.png",
    ...
    responsibilities: [
      "Assisted in student leadership and school governance",
      "Maintained discipline and uphold school values",
      "Organized and coordinated school events and activities",
      "Acted as liaison between students and administration",
      "Mentored junior students and prefects",
      "Represented student body in school decisions",
    ],
    skills: ["Leadership", "Communication", "Conflict Resolution", "Event Planning", "Mentoring"],
  },
  {
    image: "https://gateway.lk/wp-content/uploads/2019/08/gateway-logo.png",
    title: "Vice President - ICT Society",
    company: "Gateway College Colombo",
    location: "Colombo, Sri Lanka",
    duration: "2024-2025",
    type: "Leadership",
    ...
    responsibilities: [
      "Managed ICT society operations and activities",
      "Organized coding workshops and hackathons",
      "Conducted technology seminars and demonstrations",
      "Promoted digital literacy among student body",
      "Led fundraising initiative for underprivileged schools",
      "Coordinated technology education programs",
    ],
    skills: ["Leadership", "Technology Education", "Event Management", "Community Outreach", "Project Management"],
  },
  {
    image: "https://gateway.lk/wp-content/uploads/2019/08/gateway-logo.png",
    title: "House Captain",
    ...
    duration: "2023-2024",
    type: "Leadership",
    description: "Led house leadership and coordinated inter-house competitions. Organized house activities, motivated team members, and fostered spirit of unity and competition.",
    responsibilities: [
      "Led house team in inter-house competitions",
      "Organized house activities and events",
      "Motivated and coordinated team members",
      "Fostered spirit of unity and healthy competition",
      "Managed house resources and logistics",
      "Represented house in school leadership meetings",
    ],
    skills: ["Leadership", "Team Building", "Motivation", "Event Coordination", "Sports Management"],
  },
  {
    image: "https://gateway.lk/wp-content/uploads/2019/08/gateway-logo.png",
    ...
    duration: "2022-2024",
    type: "Leadership",
    description: "Led competitive swim team to multiple victories. Coordinated training schedules, motivated team members, and represented the team in inter-school competitions.",
    responsibilities: [
      "Led competitive swim team to multiple victories",
      "Coordinated training schedules and sessions",
      "Motivated and mentored team members",
      "Represented team in inter-school competitions",
      "Worked with coaches to develop training programs",
      "Organized team-building activities and events",
    ],
    skills: ["Leadership", "Athletic Performance", "Team Coordination", "Motivation", "Training Management"],
  },
];
      ...
      <Container maxWidth="lg">
        ...
        <Stack alignItems="center" spacing={2} sx={{ mb: 8, textAlign: "center" }}>
          ...
          <Typography variant="h6" sx={{ color: "rgba(255,255,255,0.7)", maxWidth: 700 }}>
            Work experience, leadership roles, and community service initiatives
          </Typography>
        ...
        <Box sx={{ mb: 8 }}>
          <SectionHeader 
            ...
            subtitle="Student leadership roles and team management positions"
            icon={<EmojiEvents />}
          />
          {leadershipExperience.map((leadership, idx) => (
            <DetailedExperienceCard key={idx} item={leadership} />
          ))}
        </Box>
        ...
        <Box>
          <SectionHeader 
            ...
            subtitle="International representation and special initiatives"
            icon={<EmojiEvents />}
          />
      ...
      <Container maxWidth="md">
        ...
        <Stack alignItems="center" spacing={1.5} sx={{ mb: 6, textAlign: "center", px: 2 }}>
          ...
          <Typography variant="body1" sx={{ color: "rgba(255,255,255,0.7)", fontSize: "0.95rem" }}>
            Professional work, leadership, and community service
          </Typography>
        ...
        <Box sx={{ mb: 6 }}>
          <SectionHeader title="Leadership Experience" icon={<EmojiEvents />} />
          {leadershipExperience.map((leadership, idx) => (
            <DetailedExperienceCard key={idx} item={leadership} />
          ))}
        </Box>
